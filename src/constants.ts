...
export const BACKGROUND_IMAGES = {
  HOME: 'home_bg.webp',
  GAME_DAY: 'day_bg.webp',
  GAME_NIGHT: 'nignt_bg.webp',  // 注意：文件名是 nignt（拼写错误），保持与原文件一致
  GAME_RAIN: 'rain_bg.webp',
  GAME_RUINED: 'ruined_walls.webp',
  GAME_RUINED_VERTICAL: 'ruined_walls_vertical.webp',
} as const;
